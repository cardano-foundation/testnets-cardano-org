...
To help you get started, we are providing test networks that consist of several nodes and stake pools. These also connect to trusted peers, those nodes in the network that your node will initially trust when building out the network. To learn more about these different types of release testnets, please visit [About &gt; Testnet introduction](/en/shelley-itn/shelley-itn-about/shelley-itn-testnet-introduction/) where the beta and nightly releases are explained. 
