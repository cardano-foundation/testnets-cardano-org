...
export default () => (
  <Svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width='273.6px' height='360px' viewBox='0 0 273.6 360' enable-background='new 0 0 273.6 360'>
    <g>
      <g>
        <path
          fill='#ffffff' d='M217.021,167.042c18.631-9.483,30.288-26.184,27.565-54.007c-3.667-38.023-36.526-50.773-78.006-54.404l-0.008-52.741
